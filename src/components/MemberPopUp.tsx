  ...
  return (
    <div>
      <div>
        ...
        <p lang="en" className="font-bold max-w-[175px] break-words hyphens-none whitespace-normal">
          {member.name}
        </p>
        <p lang="en" className="max-w-[175px] break-words hyphens-none whitespace-normal">
          {member.position}
        </p>
      </div>
