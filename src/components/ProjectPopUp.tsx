...
export default function ProjectPopUp({ year, projects }: ProjectPopUpProps) {
        ...
        <div className="
          ...
          >
            ...
            <div className="h-[150px] w-[250px] overflow-hidden mx-auto flex items-center justify-center">
              <Image
                src={thumbnailImage || "/images/wic_logo.png"}
                alt={`${year} Projects`}
                width={250}
                height={150}
        ...
        <div className="fixed inset-0 z-2 flex items-center justify-center bg-primary-medium/70">
          ...
          >
            <div className="flex justify-between items-center">
              <h2 className="text-primary-dark">{year}</h2>
              <button
            ...
            <div className="flex flex-col gap-sm mt-sm">
              {projects.map((project, i) => (
                <div key={project.year ?? i} className="border-t border-primary-medium pt-sm">
